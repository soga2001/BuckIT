...
type UserProfile struct {
	...
	Verified   bool      `json:"verified" doc:"Indicates whether the user's email is verified (true) or not (false)" required:"true"`
...
// UsersOutput represents the user operation response.
